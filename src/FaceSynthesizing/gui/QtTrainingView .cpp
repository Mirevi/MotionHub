...
namespace facesynthesizing::infrastructure::qtgui {
    ...
    void QtTrainingView::updateDatasetConfigurationGroup()
    {
        ...
        ui->dataLoaderThreadsSpinBox->setValue(trainingViewModel->dataLoaderThreads);
    ...
    void QtTrainingView::updateEvaluationConfigurationGroup()
    {
        ...
        ui->startNewVisdomServerCheckBox->setChecked(trainingViewModel->startNewVisdomServer);
        ...
        ui->startNewVisdomServerCheckBox->setEnabled(trainingViewModel->useVisdom);
    ...
    void QtTrainingView::updateVisualizationGroup()
    {
        ...
        if (trainingViewModel->visualize) {
            visualizeImage(trainingViewModel->flmImage, ui->imageFLMLabel, QImage::Format_Grayscale8);
            visualizeImage(trainingViewModel->colorRealImage, ui->imageColorRealLabel, QImage::Format_ARGB32);
            visualizeImage(trainingViewModel->colorFakeImage, ui->imageColorFakeLabel, QImage::Format_ARGB32);
            visualizeImage(trainingViewModel->depthRealImage, ui->imageDepthRealLabel, QImage::Format_Grayscale8);
            visualizeImage(trainingViewModel->depthFakeImage, ui->imageDepthFakeLabel, QImage::Format_Grayscale8);
        }
        else {
    ...
    void QtTrainingView::onDatasetConfigurationGroupChanged()
    {
        ...
        trainingViewModel->dataLoaderThreads = ui->dataLoaderThreadsSpinBox->value();
    ...
    void QtTrainingView::onEvaluationConfigurationGroupChanged()
    {
        ...
        trainingViewModel->startNewVisdomServer = ui->startNewVisdomServerCheckBox->isChecked();
