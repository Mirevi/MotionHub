...
void HierarchicSkeleton::initXsens() {
	...
	leftLeg = HierarchicJoint(Vector3f(0, -0.524f, 0), eulerToQuaternion(Vector3f(0.1f, 0, 0)), scale);
	leftLeg.setParent(&leftUpLeg);
	addJoint(&leftLeg, Joint::JointNames::LEG_L);
	...
	rightLeg = HierarchicJoint(Vector3f(0, -0.524f, 0), eulerToQuaternion(Vector3f(0.1f, 0, 0)), scale);
	rightLeg.setParent(&rightUpLeg);
	addJoint(&rightLeg, Joint::JointNames::LEG_R);
	...
	leftForeArm = HierarchicJoint(Vector3f(0.281f, 0, 0), eulerToQuaternion(Vector3f(0, -0.1f, 0)), scale);
	leftForeArm.setParent(&leftArm);
	addJoint(&leftForeArm, Joint::JointNames::FOREARM_L);
	...
	rightForeArm = HierarchicJoint(Vector3f(-0.281f, 0, 0), eulerToQuaternion(Vector3f(0, 0.1f, 0)), scale);
	rightForeArm.setParent(&rightArm);
	addJoint(&rightForeArm, Joint::JointNames::FOREARM_R);
