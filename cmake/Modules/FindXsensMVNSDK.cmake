...
FIND_PATH(XsensMVNSDK_INCLUDE_DIR NAMES xstypes.h HINTS ${CURRENT_DEPS_PATH}/include )

# Look for the library path
FIND_PATH(XsensMVNSDK_LIBRARIES_DIR NAMES xstypes64.lib HINTS ${CURRENT_DEPS_PATH}/lib )

MARK_AS_ADVANCED(XsensMVNSDK_LIBRARIES_DIR XsensMVNSDK_INCLUDE_DIR) 
# handle the QUIETLY and REQUIRED arguments and set OPENVR_SDK_FOUND to TRUE if
# all listed variables are TRUE
INCLUDE(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(XsensMVNSDK DEFAULT_MSG XsensMVNSDK_LIBRARIES_DIR XsensMVNSDK_INCLUDE_DIR)
