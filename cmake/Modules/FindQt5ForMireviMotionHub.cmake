...
FIND_PATH(Qt5ForMireviMotionHub_INCLUDE_DIR NAMES QtCore/qobject.h HINTS ${CURRENT_DEPS_PATH}/../../../include/
														${CURRENT_DEPS_PATH}/include)

# Look for the library path
FIND_PATH(Qt5ForMireviMotionHub_LIBRARIES_DIR NAMES Qt5Core.lib HINTS ${CURRENT_DEPS_PATH}/../../../lib
													${CURRENT_DEPS_PATH}/lib)

# handle the QUIETLY and REQUIRED arguments and set OPENVR_SDK_FOUND to TRUE if
# all listed variables are TRUE
INCLUDE(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(Qt5ForMireviMotionHub DEFAULT_MSG Qt5ForMireviMotionHub_LIBRARIES_DIR Qt5ForMireviMotionHub_INCLUDE_DIR)

MARK_AS_ADVANCED(Qt5ForMireviMotionHub_LIBRARIES_DIR Qt5ForMireviMotionHub_INCLUDE_DIR)
